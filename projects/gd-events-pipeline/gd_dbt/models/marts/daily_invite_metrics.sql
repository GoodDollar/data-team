...
/*
  L3 Mart: daily_invite_metrics
  Sources: semantic.invite_signups, semantic.invite_payouts (via ref)
  Grain: 1 row per (metric_date, network)
  Purpose: pre-aggregated daily invite metrics for dashboard use.
  Equivalent to the current gooddollar.Marts.daily_invite_metrics table.
